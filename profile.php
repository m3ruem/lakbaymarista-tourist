    ...
    <div class="container">
      <div class="profile-container">
        ...
        <div class="profile-info">
          ...
          <div class="profile-info-item">
            <h3>Access Level</h3>
            <p><?php echo htmlspecialchars($_SESSION['access_level']); ?></p>
          </div>
        </div>
    ...
    <div class="edit-profile-form" style="display: none;">
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" id="fname" name="fname" value="<?php echo htmlspecialchars($_SESSION['fname']); ?>">
        </div>
        <div class="form-group">
          <label for="lname">Last Name</label>
          <input type="text" id="lname" name="lname" value="<?php echo htmlspecialchars($_SESSION['lname']); ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" id="mobile" name="mobile" value="<?php echo htmlspecialchars($_SESSION['mobile']); ?>">
        </div>
        <div class="form-group">
