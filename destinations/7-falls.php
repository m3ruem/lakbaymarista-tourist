        ...
        <main class='main' style="padding-top: 80px;">
            <div class="swiper-container gallery-top">
                <div class="swiper-wrapper">
                    ...
                    <section class="islands swiper-slide">
                        <img src="../destinations/7-falls/1.jpg" alt="" class="islands__bg">
                    ...
                    <section class="islands swiper-slide">
                        <img src="../destinations/7-falls/2.jpg" alt="" class="islands__bg">
					...
					<section class="islands swiper-slide">
                        <img src="../destinations/7-falls/3.jpg" alt="" class="islands__bg">
            ...
            <div class="controls gallery-thumbs">
                <div class="controls__container swiper-wrapper">
                    <img src="../destinations/7-falls/1.jpg" alt="" class="controls__img swiper-slide">
                    <img src="../destinations/7-falls/2.jpg" alt="" class="controls__img swiper-slide">
                    <img src="../destinations/7-falls/3.jpg" alt="" class="controls__img swiper-slide">
                </div>
            </div>
        </main>
                            ...
                            <div class="wd-full">
                                ...
                                <div class="entry-content entry-content-single" itemprop="description">
                                    <p>1. Hikong Alo (Passage Falls)</p>
										...
										These enchanting falls are a captivating natural wonder in Lake Sebu, South Cotabato, and their beauty is truly awe-inspiring! 😊 You can explore them and enjoy the lush green surroundings when you visit this paradise. 🌿🌊
