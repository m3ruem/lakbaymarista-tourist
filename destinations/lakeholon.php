        ...
        <main class='main' style="padding-top: 80px;">
            <div class="swiper-container gallery-top">
                <div class="swiper-wrapper">
                    ...
                    <section class="islands swiper-slide">
                        <img src="https://alexanderduca.com/wp-content/uploads/2018/10/IMG20181011170448-2400x1200.jpg" alt="" class="islands__bg">

                        <div class="islands__container bd-container">
                            <div class="islands__data">
                                <h2 class="islands__subtitle"></h2>
                                <h1 class="islands__title">Lake Holon</h1>
                                <p class="islands__description">Named after the T'boli word for "deepwater," is a paradise for adventure seekers and nature enthusiasts.</p>
                                <a href="/destinationcontents/lkholon.html" class="islands__button">View More <i class='bx bx-right-arrow-alt islands__button-icon'></i></a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="islands swiper-slide">
                        <img src="https://www.taraletsanywhere.com/wp-content/uploads/2016/07/View-deck-of-Lake-Holon-1.jpg" alt="" class="islands__bg">

                        <div class="islands__container bd-container">
                            <div class="islands__data">
                                <h2 class="islands__subtitle"></h2>
                                <h1 class="islands__title">Lake Holon</h1>
                                <p class="islands__description">The challenging trek, particularly the Kule trail, will test your endurance but reward you with breathtaking views.</p>
                                <a href="/destinationcontents/lkholon.html" class="islands__button">View More <i class='bx bx-right-arrow-alt islands__button-icon'></i></a>
                            </div>
                        </div>
                    </section>
					<section class="islands swiper-slide">
                        <img src="https://thesneakytraveller.com/wp-content/uploads/2023/07/Lake-Holon-Campsite.jpg" alt="" class="islands__bg">

                        <div class="islands__container bd-container">
                            <div class="islands__data">
                                <h2 class="islands__subtitle"></h2>
                                <h1 class="islands__title">Lake Holon</h1>
                                <p class="islands__description">Legends speak of 15 guardians, embodied by the surrounding mountains, who protect the lake's beauty.</p>
                                <a href="/destinationcontents/lkholon.html" class="islands__button">View More <i class='bx bx-right-arrow-alt islands__button-icon'></i></a>
                            </div>
                        </div>
                    </section>
            ...
            <div class="controls gallery-thumbs">
                <div class="controls__container swiper-wrapper">
                    <img src="https://alexanderduca.com/wp-content/uploads/2018/10/IMG20181011170448-2400x1200.jpg" alt="" class="controls__img swiper-slide">
                    <img src="https://www.taraletsanywhere.com/wp-content/uploads/2016/07/View-deck-of-Lake-Holon-1.jpg" alt="" class="controls__img swiper-slide">
                    <img src="https://thesneakytraveller.com/wp-content/uploads/2023/07/Lake-Holon-Campsite.jpg" alt="" class="controls__img swiper-slide">
                </div>
            </div>
        </main>
...
<div id="content">
            ...
            <article id="post-40871" class="post-40871 hentry" itemscope="itemscope" itemtype="http://schema.org/CreativeWorkSeries">
                <div class="ts-breadcrumb bixbox">
                    <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        ›
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                            <a itemprop="item" href="../destinations/lakeholon.php"><span itemprop="name">Lake Holon</span></a>
                    ...
                    <div class="bigcontent nobigcover">
                        <div class="thumbook">
                            <div class="thumb" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                                <img class="wp-post-image" src="https://desoncun.files.wordpress.com/2019/04/dsf4739-1.jpg?w=620" title="" alt="lakeholon" decoding="async" itemprop="image" fetchpriority="high">
                            </div>
                            <div class="rt">
                        ...
                        <div class="infox">
                            <h1 class="entry-title" itemprop="name">Lake Holon</h1>
                            <div class='socialts'>
                                <a href="https://www.facebook.com/LakeHolonOfficialPage" target="_blank" class="fb">
                            ...
                            <div class="wd-full">
                                ...
                                <div class="entry-content entry-content-single" itemprop="description">
                                    <p></p>
										...
										Formed by the wrath of Mount Parker (also known as Mount Melibingoy) centuries ago, Lake Holon sits at an impressive 4,700 feet above sea level.  This volcanic crater lake boasts over 300 hectares of pristine water, reflecting the surrounding mountains and lush greenery in its crystal-clear depths.  Nicknamed the "Crown Jewel of the South," Lake Holon is a sight that will leave you breathless.</p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
    ...
    <form id="bookingForm" action="../booking.php" method="POST" style="display: none;">
        ...
        <input type="hidden" name="place_name" value="lakeholon">
    </form>
